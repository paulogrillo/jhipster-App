...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().nome(DEFAULT_NOME).cpf(DEFAULT_CPF).rg(DEFAULT_RG);
        return usuario;
    }
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().nome(UPDATED_NOME).cpf(UPDATED_CPF).rg(UPDATED_RG);
        return usuario;
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.nome(UPDATED_NOME).cpf(UPDATED_CPF).rg(UPDATED_RG);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nome(UPDATED_NOME).rg(UPDATED_RG);
    ...
    void fullUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nome(UPDATED_NOME).cpf(UPDATED_CPF).rg(UPDATED_RG);
