...
export class UsuarioComponent implements OnInit {
  ...
  constructor(protected usuarioService: UsuarioService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.usuarios = [];
    ...
    this.usuarioService
      ...
      .subscribe(
        (res: HttpResponse<IUsuario[]>) => {
          ...
          this.paginateUsuarios(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
  ...
  protected paginateUsuarios(data: IUsuario[] | null, headers: HttpHeaders): void {
